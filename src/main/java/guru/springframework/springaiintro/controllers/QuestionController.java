...
public class QuestionController {
    ...
    public GetCapitalResponse askQuestion(@RequestBody GetCapitalRequest getCapitalRequest) {
        return openAIService.getCapitalWithInfoBean(getCapitalRequest);
    }

    @PostMapping("/capitalWithInfo")
    public GetCapitalResponse askCapitalWithInfo(@RequestBody GetCapitalRequest getCapitalRequest) {
        return openAIService.getCapitalWithInfoBean(getCapitalRequest);
    }
